    ...
    : wxScrolledWindow(parent, id)
{
    ...
    // Make _chatLogic a unique smart pointer to a ChatLogic instance to grant exclusive ownership to ChatBotPanelDialog class
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    // No longer needs to be deallocated manually as the smart pointer will deallocate it when it goes out of scope (destructs)
    //delete _chatLogic;
